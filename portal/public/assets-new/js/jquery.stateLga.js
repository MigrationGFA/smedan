...
const toggleLGARes = (target) => {
  let state = target.value, // Get value of state
    ...
    lgas = [...selectLGAOption, ...Object.values(lgaList)],
    form = target.parentElement.parentElement.parentElement.parentElement,
    lgaSelect = form.querySelector(".select-lga-res"),
  ...
  lgas.forEach((lga) => {
    ...
    // Disable and select the "Select LGA..." option
    lga.includes("elect")
      ? setAttributes(opt, { disabled: "disabled", selected: "selected" })
      : "";
