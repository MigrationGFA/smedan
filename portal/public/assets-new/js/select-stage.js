...
// Toggle Bank Info based on selected value
const toggleBankInfo = (target) => {
  var selectedValue = target.value;

  // Get all bank info elements
  var bankInfo1 = document.getElementById('bank-info-1');
  var bankInfo2 = document.getElementById('bank-info-2');
  var bankInfo3 = document.getElementById('bank-info-3');
  var bankInfo4 = document.getElementById('bank-info-4');

  // Toggle display based on selection
  if (selectedValue === 'Yes') {
    bankInfo1.style.display = 'none';
    bankInfo2.style.display = 'none';
    bankInfo3.style.display = 'none';
    bankInfo4.style.display = 'none';
  } else if (selectedValue === 'No') {
    bankInfo1.style.display = 'inline';
    bankInfo2.style.display = 'block';
    bankInfo3.style.display = 'block';
    bankInfo4.style.display = 'block';
  }
};
...
const toggleWemaAcctDiv = (target) => {
  const partnerInterest = document.getElementById("partnerInterest").value;
  const wemaAcctDiv = document.getElementById("wemaAcctDiv");
  
  if (partnerInterest === "Yes") {
      wemaAcctDiv.style.display = "block";
  } else {
      wemaAcctDiv.style.display = "none";
  }
}
