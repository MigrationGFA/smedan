            ...
            <div class="auth-inner row m-0">
              ...
              <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                  <h2 class="card-title fw-bold mb-1">Welcome to FGN-ALAT Skillnovation</h2>
                  ...
                  <form class="auth-login-form mt-2" action="<?php echo base_url('gfa/signinActionTest'); ?>" method="POST">
                    <div class="mb-1">
                   ...
                   <p class="text-center mt-2"><a href="https://fgn-alat.dimpified.com/register/"><span>New on our platform?<br>Open an Account</span></a></p>
