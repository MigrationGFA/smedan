...
<div class="blog-detail-wrapper">
  <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          <form action="#" id="#EventForm" class="form EventForm" enctype="multipart/form-data">
            <div class="row">
            <?php $getSliderEdit = $this->gfa_model->getSliderEdit($id);  ?>
              <div class="col-md-6 col-12">
              <label>Slider Title </label>
                <div class="mb-2">
                  <input type="text" name="slider_title" class="form-control" required value="<?php echo $getSliderEdit[0]['slider_title'] ?>" />
                </div>
              </div>
              ...
              <label>Slider URL </label>
                <div class="mb-2">
                  <input type="text" name="slider_url" class="form-control" required value="<?php echo $getSliderEdit[0]['slider_url'] ?>" />
                </div>
              </div>
              ...
              <div id="full-wrapper col-12">
                ...
                <label class="form-label" for="content">Slider Content</label>
                  <textarea name="slider_content" class="form-control" rows="2" required><?php echo $getSliderEdit[0]['slider_content'] ?></textarea>
                </div>
              </div>
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url("gfa/edit_sliderpostpro"); ?>",
	 error:function() {$(".displayAction").html('Error')},
	 beforeSend:function() {$(".displayAction").html('Updating Slider...'); $(".EventBtn").prop('disabled', false);},
	 processData: false,
    contentType: false,
