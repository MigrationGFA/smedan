...
<!--   The investor name & title -->
            ...
            <h4 class="card-title">Course Progress in % <?php //echo $this->encrypt->decode($this->session->userdata('cor_info')) ; ?> </h4>
...
<!--Options to reach out -->
 ...
 <?php 
  ...
  <?php         
           ...
           $row  = $this->gfa_model->GetUsersGreaterThan60($batch);
            ...
            <table class="table" id="table">
              ...
              <tbody>
                ...
                <tr class="data">
                  ...
                  <td>
                  <?php echo $rowArray['State']; ?>
                   </td>
                    <td>
                   <?php echo $rowArray['Category']; ?>
                   </td>
