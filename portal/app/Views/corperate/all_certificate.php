<?php 
                ...
                $certificateData = $this->gfa_model->CertificatesListByBatch($batch);
      ?>
<!-- BEGIN: Content-->
...
<!--The industries the investor invests in -->
            ...
            <h4 class="card-title">Accessed Certificates(Total: <?php echo count($certificateData)?>)</h4>
          ...
          <div class="table-responsive">
            ...
            <table class="table tablemanager">
              <thead>
				...
				foreach($certificateData as $certificateInfo){  
             ...
             ?>
                ...
                <!-- <td class="text-nowrap"> -->
                  ...
                  <!-- </td> -->
                <td class="text-nowrap">
                   <?php echo $certificateInfo['time_submit'] ?>
                  </td>
                  <td>
                   <?php echo $certificateInfo['name'] ?>
                  </td>
     				<td class="">
                    <?php echo $certificateInfo['email'] ?>
                  </td>
                <td class="">
                <?php if($certificateInfo['score'] < 60){ echo "100"; }else{ echo $certificateInfo['score']; } ?>
                  </td>
                <td class="text-nowrap">
                    <?php echo $certificateInfo['course'] ?>
                  </td>
