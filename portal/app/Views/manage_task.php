              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>gfa/add_task">+ Add Task </a>
                    </li>
          ...
          <div class="table-responsive">
            ...
            <table class="table tablemanager">
              ...
              <tbody class="loadCorperate">
               ...
               <a href="<?php echo base_url()?>gfa/task/<?php echo $rowArray['ref_id']; ?>" ><i data-feather="external-link" class="text-success font-medium-1"></i>View</a> |
               <a href="<?php echo base_url()?>gfa/edit_task/<?php echo $rowArray['id']; ?>" ><i data-feather="edit" class="text-success font-medium-1"></i>Edit</a> | 
               <a href="#" alt="delete Task" class="deletebtn"><i data-feather="trash" class="text-success font-medium-1"></i>Delete<span style="display: none;"><?php echo $rowArray['id'] ?></span></a>  
                 ...
                 <td>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-bolder">Questions(<?php echo $this->gfa_model->countTaskQuestions($rowArray['ref_id']);?>)</div>
                      </div>
                    </div>
                  </td>
...
tempInput.remove();
  ...
  $(this).closest('tr').remove();
    ...
    $.ajax({
     data:{id:id},
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/deleteTask",
