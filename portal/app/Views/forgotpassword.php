              ...
              <div class="header-right flex flex-align-c">
                ...
                <div class="logo">
                  <a class="navbar-brand" href="#">
                    <img
                      src="<?php echo base_url('public/assets/images/logo/FGN-ALAT-Logo.png'); ?>"
                      width="180px"
                      height="auto"
                      alt="image"
            ...
            <div class="container" style="background-color: rgba(0, 0, 0, 0.2)">
              <div class="row">
                            ...
                            <div class="item">
                              <div class="heading mb32">
                                <h2
                                  ...
                                  style="color: #fff"
                                >
                                <?= $rowArray['slider_title']?>
                                </h2>
                              </div>
                              <p style="text-align: left"><?= $rowArray['slider_content']?></p>
                ...
                <div class="col-lg-3 mt32" id="signin">
                  <form
                    class="auth-login-form mt-2 forgotPasswordForm"
                    action=""
                    method="POST"
                  >
                    <div class="mb-1">
                      <label class="form-label white-text h6 displayData" for="login-email"
                        ><?php if(!empty($message)){ echo $message; }else{ echo "Please enter your email below";} ?></label
                      >
                      <input
                        class="form-control"
                        id="login-email"
                    ...
                    <button
                      class="btn btn-primary w-100 waves-effect waves-float waves-light btnForgotPassword"
                      tabindex="4"
                    >
                      Submit
                    </button>
                    <p class="text-center mt-2"><a href="<?php echo base_url('gfa/login') ?>"><span class="white-text">Back to Login</span></a></p>
                  </form>
                </div>
              </div>
            </div>
        ...
        <div class="footer-bottom">
          <div class="container">
            <div class="inner flex flex-content-sb flex-align-c py-2">
              <div class="copyright">
                © 2024 FGN-ALAT Skillnovation program. All rights reserved
              </div>
            </div>
          </div>
        </div>
