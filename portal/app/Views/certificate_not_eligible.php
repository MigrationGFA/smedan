...
<div class="row">
  ...
  <div class="col-lg-6 mb-4 mb-md-0">
    <div class="card">
      <h5 class="card-header">Skills Course Analysis</h5>
      <div class="card-body">
      <ul class="list-unstyled mb-4 mt-3">
          <li class="d-flex align-items-center mb-3"><i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 text-heading">Full Name:</span> <span><?=$email?></span></li>
  ...
  <?php //$getCerticateData = $this->gfa_model->GetEachUserCourseList($email);
       $courseTrack = $this->gfa_model->get_user_learning_summary($email);
  ?>
  <div class="col-lg-6 mb-4 mb-md-0">
    <div class="card">
      ...
      <ul class="list-unstyled mb-4 mt-3">
          ...
          <!-- <li class="d-flex align-items-center mb-3"><i class="ti ti-flag text-heading"></i><span class="fw-medium mx-2 text-heading">Country:</span> <span>USA</span></li> -->
          <li class="d-flex align-items-center mb-3"><i class="ti ti-file-description text-heading"></i><span class="fw-medium mx-2 text-heading">Course:</span> <span><?php echo $getCerticateData[0]['CurrentlyOngoing'] ?></span></li>
        </ul>
      </div>
    </div>
  </div>
