...
<div class="row">
      ...
      <div class="card-body">
        <div class="alert alert-danger alert-dismissible" role="alert">
         ...
         <?php if($course_type == "soft" ){ ?>
          <p class="mb-0">You are not eligible to view your certificate as you have not reached the passing mark of 80% for the course progress.</p><p class="mb-0">To increase your score to 80% and generate your certificate, please continue with the assigned courses and attempt the quizzes.</p>
          <?php }  ?>
  ...
  <?php if($course_type == "soft" ){ ?>
  <?php $getCerticateData = $this->gfa_model->GetUserProgressSoftCurriculumWema($email);
  $getCerticateName = $this->gfa_model->GetCertificateEligibleSoftCurriculumWema($email); ?>
  <div class="col-lg-6 mb-4 mb-md-0">
    <div class="card">
      <h5 class="card-header">Course Analysis</h5>
      <div class="card-body">
