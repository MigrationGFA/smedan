 ...
 <?php 
    ...
    <div class="col-lg-12 col-12">
        <div class="col-lg-12 text-center mb-2">
            <a href="<?php echo base_url(); ?>gfa/export_reg_state" class="btn btn-secondary btn-next" style="margin:5px;"> Export Data </a> 
  ...
  <?php         
           ...
           $row  = $this->gfa_model->getStartUpDetailsReg($reg_type); 
             ...
             $row  = $this->gfa_model->getStartUpDetailsRegAllLimitByState('Ogun');   
           }
