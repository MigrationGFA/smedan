  ...
  <div class="card-body row  g-4">
    <div class="col-12 col-md-8 card-separator ">
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <a href="<?php echo base_url('gfa/unlishified_reg/provider'); ?>" class="userActivity" ls="job provider">
        <div class="d-flex align-items-center gap-3">
          <span class="bg-label-info p-2 rounded">
            <i class='ti ti-user-check ti-xl'></i>
          </span>
          <div class="content-right">
            <p class="mb-0"><h4 class="text-info mb-0">Post</h4>your Jobs</p>
          </div>
        </div>
        </a>
        <a href="#" class="userActivity" ls="service provider">
        <div class="d-flex align-items-center gap-3">
          <span class="bg-label-warning p-2 rounded">
            <i class='ti ti-device-laptop ti-xl'></i>
          </span>
          <div class="content-right">
            <p class="mb-0"><h4 class="text-warning mb-0">Post</h4>your Services </p>
            <!-- <span class="text-dark">(coming soon)</span> -->
          </div>
        </div>
      </a>
      </div>
      ...
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topCourses">
            ...
            <a class="dropdown-item" href="<?php echo base_url('gfa/soft_skills'); ?>">Soft Skill</a>
            <a class="dropdown-item" href="<?php echo base_url('gfa/learning_path'); ?>">Technical Skill</a>
          </div>
        </div>
      </div>
      <div class="card-body">
...
<div class="row mb-4 g-4">
  ...
  <div class="col-12 col-xl-4 col-md-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title m-0 me-2">Recommended Service</h5>
        <div class="dropdown">
          <button class="btn p-0" type="button" id="topCourses" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="ti ti-dots-vertical"></i>
          </button>
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topCourses">
            <a class="dropdown-item" href="https://unleashified.com/jobs/services-list" target="_blank">Onboard your Service</a>
            <a class="dropdown-item" href="https://unleashified.com/jobs/services-list" target="_blank">Buy a Service</a>
          </div>
        </div>
      </div>
      <div class="card-body">
  ...
  <div class="col-12 col-xl-4 col-md-4">
    <div class="card h-100">
      <div class="card-body">
        ...
        <h4 class="mb-2 pb-1">Mentorship Sessions</h4>
        ...
        <div class="row mb-3 g-3">
          <div class="col-6">
            <div class="d-flex">
              ...
              <div>
                <h6 class="mb-0 text-nowrap">6th Apr - </h6>
        ...
        <a href="<?php echo base_url('gfa/resource_center'); ?>" class="btn btn-primary w-100">Get Started</a>
      </div>
    </div>
  </div>
...
//load analytic page 
    ...
    //load Recommended Jobs
    $.ajax({
        url: '<?php echo base_url("gfa/loadDashboardServiceRecomm") ?>',
        method: 'POST',
        beforeSend: function() {
            // Code to be executed before the AJAX request is sent
        ...
        success: function(response) {
          ...
          $(".loadDashboardJobsRecomm").html(response);
        
            
        },
        error: function(xhr, status, error) {
            // Handle errors if the AJAX request fails
            $(".loadDashboardJobsRecomm").html('Coming Soon', status, error);
        }
    });
